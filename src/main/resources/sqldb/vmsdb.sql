...
VALUES	('Ha noi','1993-04-22','nguyenvanna@gmail.com','Nguyen Van A',1,'123456','$2a$10$khF6Dd/HkUhbFc1YY9gXP.GBM5LOM0UhBJXhVUNc1OrOhW3oAVGMK','0123456789','anv')
		,('Hai Duong','1995-03-24','buivanb@gmail.com','Bui Van B',1,'234567','$2a$10$khF6Dd/HkUhbFc1YY9gXP.GBM5LOM0UhBJXhVUNc1OrOhW3oAVGMK','0456756789','bvb')
		,('Ha noi','1994-09-12','tranthic@gmail.com','Tran Thi C',0,'345678','$2a$10$khF6Dd/HkUhbFc1YY9gXP.GBM5LOM0UhBJXhVUNc1OrOhW3oAVGMK','0123678989','ctt')
		,('Ha noi','1999-05-28','nguyenvand@gmail.com','Nguyen Van D',1,'456789','$2a$10$khF6Dd/HkUhbFc1YY9gXP.GBM5LOM0UhBJXhVUNc1OrOhW3oAVGMK','012343259','dnv')
		,('Ha noi','2002-08-03','nguyenthie@gmail.com','Nguyen Thi E',0,'123678','$2a$10$khF6Dd/HkUhbFc1YY9gXP.GBM5LOM0UhBJXhVUNc1OrOhW3oAVGMK','0123456754','ent')
...
INSERT INTO vaccine
VALUES	('11',1,NULL,NULL,100,'OK','2020-03-04','2021-03-02',NULL,'VCA','12')
		,('12',1,NULL,NULL,200,'OK','2020-05-06','2021-09-08',NULL,'VCB','13')
		,('13',1,NULL,NULL,10,'OK','2020-01-02','2021-03-03',NULL,'VCC','17')
		,('14',1,NULL,NULL,150,'OK','2020-07-09','2021-07-12',NULL,'VCD','15')
		,('15',1,NULL,NULL,120,'OK','2020-06-18','2021-6-20',NULL,'VCE','16')
		,('16',1,NULL,NULL,180,'OK','2020-09-22','2021-09-23',NULL,'VCF','11')
		,('17',1,NULL,NULL,120,'OK','2020-08-28','2021-4-21',NULL,'VCG','11')
		,('18',1,NULL,NULL,150,'OK','2020-04-09','2021-11-18',NULL,'VCH','19')
		,('19',1,NULL,NULL,190,'OK','2020-05-02','2021-10-23',NULL,'VCI','16')
		,('20',1,NULL,NULL,130,'OK','2020-07-08','2021-05-05',NULL,'VCK','15')
...
VALUES	(NULL,'2021-3-14','HN','2021-3-16',3,'abc',NULL,3,'15')
		,(NULL,'2022-10-12','HN','2022-10-16',2,'abc',NULL,5,'13')
		,(NULL,'2021-1-15','HN','2021-1-18',4,'abc',NULL,1,'18')
		,(NULL,'2020-12-14','HN','2020-12-20',2,'abc',NULL,2,'14')
		,(NULL,'2021-6-14','HN','2021-11-14',3,'abc',NULL,9,'13')
		,(NULL,'2020-8-14','HN','2020-11-14',6,'abc',NULL,10,'15')
		,(NULL,'2021-6-14','HN','2021-11-14',5,'abc',NULL,12,'16')
		,(NULL,'2020-4-14','HN','2020-11-14',2,'abc',NULL,9,'11')
		,(NULL,'2022-5-14','HN','2022-11-14',2,'abc',NULL,9,'19')
		,(NULL,'2021-7-14','HN','2021-11-14',3,'abc',NULL,11,'18')